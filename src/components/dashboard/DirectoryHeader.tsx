...
export default function DirectoryHeader() {
    return (
        <header className="container mx-auto px-6 md:px-12 pt-32 md:pt-64 pb-16 md:pb-32 border-b border-white/5">
            <div className="flex flex-col md:flex-row justify-between items-end gap-12">
                <div>
                    <span className="text-blue-500 font-mono text-[9px] tracking-[0.4em] mb-4 block">
                        MAIN_DIRECTORY
                    </span>
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[8vw] font-black leading-[0.8] tracking-tighter text-white opacity-90">
                        SELECTED<br />
